...
function sort() {
    ...
    if (value === "high to low") {
        ...
        mensData.map(function (elem, index, array) {
            ...
            var strikeoffspan = document.createElement("div");
            strikeoffspan.setAttribute("class", "strikeSpan");

            var strikeoff = document.createElement("p");
            strikeoff.innerText = elem.strikedoffprice;
            strikeoff.setAttribute("class", "strike");

            var off = document.createElement("span");
            off.innerText = elem.off;
            off.setAttribute("class", "off");

            strikeoffspan.append(strikeoff, off);

            parent.append(img, name, price, strikeoffspan);

            document.querySelector("#mainparent").append(parent);
        });
    } else if (value === "all") {
        mensData.map(function (elem, index, array) {
            document.querySelector("#mainparent").innerHTML = null
